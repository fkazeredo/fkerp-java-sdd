...
| 8d — Payout | 2026-06-29 17:17 (-03:00) | 2026-06-29 18:15 (-03:00) | ✅ Subagente (só SPEC-0017) **morreu por reinício do processo** durante 8d-3; o supervisor **recuperou**: 8d-1/8d-2/8d-3 já commitados+mergeados em develop, `./mvnw verify` **292 tests** verde (reverificado), release `0.12.0` completado (tag, main+develop) e **pushado** pelo supervisor. Payout (repasse/reembolso/parcelamento) + ACL de pagamento (webhook idempotente, ADR 0006) + SupplierSettled→Finance + comprovante; armadilha do merchant preservada. DL-0048…0051. |
