...
| 8d — Payout | 2026-06-29 17:17 (-03:00) | _in progress_ | Supervisor loop (8b1087fe): sem 🟡 → próxima ⬜ = 8d; marcada 🟡; `RUN-PHASE` FASE-ALVO=8/só-0017 delegado a um subagente. |
...
| **8d** | Payout | SPEC-0017 | 🟡 In progress | Supervisor loop (8b1087fe) 2026-06-29 17:17 (-03:00); RUN-PHASE FASE-ALVO=8, sub-spec **0017** apenas. Repasse/liquidação/reembolso + parcelamento + comprovante (publica `SupplierSettlement` que o Finance já espera). |
