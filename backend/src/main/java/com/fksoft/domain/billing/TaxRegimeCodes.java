 ...
 * DL-0115). After {@code TaxRegime} became an editable cadastro, the regime still selects the
 * {@link TaxRegimeStrategy} (Simples/Presumido/Real compute ISS and withholdings differently) —
 * that branching is preserved here as code constants. The cadastro owns the extensible set +
 * labels; this class owns the wired behavior.
 *
